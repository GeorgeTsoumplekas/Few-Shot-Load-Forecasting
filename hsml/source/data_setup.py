...
class AcrossTasksDataset(Dataset):
    ...
    def __init__(self, data, batch_idx, day_measurements, filenames, embeddings):
...
def get_tasks_dataset(data_filenames, pred_days, test_days, week_num, day_measurements, embeddings):
